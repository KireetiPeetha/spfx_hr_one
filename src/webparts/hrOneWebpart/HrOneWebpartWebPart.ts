...
import { IHrOneWebpartProps } from './components/IHrOneWebpartProps';

export interface IHrOneWebpartWebPartProps {
  description: string;
}

export default class HrOneWebpartWebPart extends BaseClientSideWebPart<IHrOneWebpartWebPartProps> {
  ...
  public render(): void {
    ...
    const element: React.ReactElement<IHrOneWebpartProps> = React.createElement(
      HrOneWebpart,
      {
